...
function WorkCardInner({ project }: { project: Project }) {
  return (
    <div
      className={cn(
        "group relative flex h-80 flex-col justify-between overflow-hidden rounded-2xl p-8 ring-1 transition-transform duration-500 hover:-translate-y-1",
        project.locked
          ? "border border-dashed border-foreground/20 ring-0"
          : "ring-foreground/10",
      )}
      style={{
